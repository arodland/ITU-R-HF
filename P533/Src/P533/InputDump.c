...
DLLEXPORT int InputDump(struct PathData *path) {
	...
	printf("\tpath->foF2[0][0][0] addr       0x%llx contents %lf\n", (unsigned long long)&path->foF2[0][0][0], path->foF2[0][0][0]);
	printf("\tpath->foF2[23][0][0] addr      0x%llx contents %lf\n", (unsigned long long)&path->foF2[23][0][0], path->foF2[23][0][0]);
	printf("\tpath->foF2[0][240][0] addr     0x%llx contents %lf\n", (unsigned long long)&path->foF2[0][240][0], path->foF2[0][240][0]);
	printf("\tpath->foF2[0][0][120] addr     0x%llx contents %lf\n", (unsigned long long)&path->foF2[0][0][120], path->foF2[0][0][120]);
	printf("path->M3kF2 addr         0x%llx\n",                         (unsigned long long)&path->M3kF2);
	printf("\tpath->M3kF2[0][0][0] addr       0x%llx contents %lf\n", (unsigned long long)&path->M3kF2[0][0][0], path->M3kF2[0][0][0]);
	printf("\tpath->M3kF2[23][0][0] addr      0x%llx contents %lf\n", (unsigned long long)&path->M3kF2[23][0][0], path->M3kF2[23][0][0]);
	printf("\tpath->M3kF2[0][240][0] addr     0x%llx contents %lf\n", (unsigned long long)&path->M3kF2[0][240][0], path->M3kF2[0][240][0]);
	printf("\tpath->M3kF2[0][0][120] addr     0x%llx contents %lf\n", (unsigned long long)&path->M3kF2[0][0][120], path->M3kF2[0][0][120]);
